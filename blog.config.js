...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'nobelium', // 主题， 支持 ['next','hexo',"fukasawa','medium','nobelium'] @see https://preview.tangly1024.com
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '阿Q的生活日志🎨', // 作者简介
